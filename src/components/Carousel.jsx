  ...
  return (
    <>
     <div className='width-[50rem] h-[90vh] overflow-hidden scroll-smooth z-10'>{/*increase width to show content*/}
      ...
      {data.length > 2 &&
      <div className='flex flex-col md:flex-row justify-evenly items-center backdrop-brightness-100'>
        <div className='flex flex-col justify-center items-start w-1/2 h-[100vh]'>
          ...
          <div className='flex w-1/2 justify-between'>
            <button className='bg-yellow-600 p-3 rounded-2xl inline-flex justify-center items-center hover:bg-transparent hover:outline outline-2'>Add to Favourite
            ...
            <button className='p-3 rounded-2xl inline-flex items-center outline outline-2 dark:hover:bg-white dark:hover:text-black' onClick={()=>navigate(`movie/${data[1].imdbID}`)}>Movie Details
        ...
        <div className='z-50 shadow-inner opacity-90'>
